        ...
        return (
            <ModalWindow>
                <div className="modal-body">
                    ...
                    />
                    {this.state.loginError && <Warning strongText="Предупреждение!" text="Логин должен быть корректным email."/>}
                    <input type="password"
                           className="form-control"
                    ...
                    />
                    {this.state.passwordError && <Warning strongText="Предупреждение!" text="Пароль не может быть пустым."/>}
                    ...
                    {this.state.confirmError && <Warning strongText="Предупреждение!" text="Подтверждение неверно."/>}
                ...
                <div className="modal-footer">
                    ...
                    <Button classSet="btn-danger" handleClick={this.cancelClick} text="Отмена"/>
                </div>
            </ModalWindow>
        )
    }
