...
/***/ function(module, exports, __webpack_require__) {
	...
	var _product = __webpack_require__(192);

	var _product2 = _interopRequireDefault(_product);

	var _category = __webpack_require__(194);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _types = __webpack_require__(193);
	...
	exports.default = function () {
	    ...
	    switch (action.type) {
	        case _types.OPEN_ADD_PRODUCT_MODAL:
	            return Object.assign({}, state, {
	                openAddProductModal: action.openAddProductModal
	            });
	        case _types.CLOSE_PRODUCT_MODAL:
	            return Object.assign({}, state, {
	                openAddProductModal: action.openAddProductModal,
	                openEditProductModal: action.openEditProductModal,
	                productID: null
	            });
	        case _types.OPEN_EDIT_PRODUCT_MODAL:
	            return Object.assign({}, state, {
	                openEditProductModal: action.openEditProductModal,
	                productID: action.productID
	            });
	        case _types.OPEN_DELETE_PRODUCT_MODAL:
	            return Object.assign({}, state, {
	                openDeleteProductModal: action.openDeleteProductModal,
	                productID: action.productID
	            });
	        case _types.CLOSE_DELETE_MODAL:
	            return Object.assign({}, state, {
	                openDeleteProductModal: action.openDeleteProductModal,
	                productID: action.productID
	            });
	        case _types.ADD_PRODUCT:
	            var prod = state.prods ? state.prods : "";
	            return Object.assign({}, state, {
	                prods: [].concat(_toConsumableArray(prod), [action])
	            });
	        case _types.GET_PRODUCTS:
	            return Object.assign({}, state, action.products);

	        case _types.EDIT_PRODUCT:
	            prod = state.prods.map(function (p) {
	            ...
	            return Object.assign({}, state, {
	                prods: [].concat(_toConsumableArray(prod))
	            });
	        case _types.REMOVE_PRODUCT:
	            var p = state.prods.filter(function (f) {
	                return f.productID !== action.productID;
	            });

	            return Object.assign({}, state, {
	                prods: [].concat(_toConsumableArray(p))
	            });
	    }
	    return state;
	};
...
/***/ function(module, exports) {
	...
	var OPEN_ADD_PRODUCT_MODAL = exports.OPEN_ADD_PRODUCT_MODAL = 'openAddProductModal';
	var OPEN_EDIT_PRODUCT_MODAL = exports.OPEN_EDIT_PRODUCT_MODAL = 'openEditProductModal';
	var OPEN_DELETE_PRODUCT_MODAL = exports.OPEN_DELETE_PRODUCT_MODAL = 'openDeleteProductModal';

	var OPEN_ADD_CATEGORY_MODAL = exports.OPEN_ADD_CATEGORY_MODAL = 'openAddCategoryModal';
	var OPEN_DELETE_CATEGORY_MODAL = exports.OPEN_DELETE_CATEGORY_MODAL = 'openDeleteCategoryModal';
	var SELECT_CATEGORY = exports.SELECT_CATEGORY = 'selectCategory';

	var CLOSE_PRODUCT_MODAL = exports.CLOSE_PRODUCT_MODAL = 'closeAddProductModal';
	var CLOSE_CATEGORY_MODAL = exports.CLOSE_CATEGORY_MODAL = 'closeAddCategoryModal';
	var CLOSE_DELETE_MODAL = exports.CLOSE_DELETE_MODAL = 'closeDeleteCategoryModal';

	var ADD_PRODUCT = exports.ADD_PRODUCT = 'addProduct';
	var ADD_CATEGORY = exports.ADD_CATEGORY = 'addCategory';
	var REMOVE_CATEGORY = exports.REMOVE_CATEGORY = 'removeCategory';

	var EDIT_PRODUCT = exports.EDIT_PRODUCT = 'editProduct';
	var REMOVE_PRODUCT = exports.REMOVE_PRODUCT = 'removeProduct';

	var GET_PRODUCTS = exports.GET_PRODUCTS = 'getProducts';
	var GET_CATEGORIES = exports.GET_CATEGORIES = 'getCategories';
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	    ...
	    var categories = state.cats ? state.cats : "";
	    switch (action.type) {
	        case _types.CLOSE_CATEGORY_MODAL:
	            return Object.assign({}, state, {
	                openAddCategoryModal: action.openAddCategoryModal
	            });
	        case _types.OPEN_ADD_CATEGORY_MODAL:
	            return Object.assign({}, state, {
	                openAddCategoryModal: action.openAddCategoryModal,
	                categoryID: action.categoryID
	            });

	        case _types.OPEN_DELETE_CATEGORY_MODAL:
	            return Object.assign({}, state, {
	        ...
	        case _types.SELECT_CATEGORY:
	            return Object.assign({}, state, {
	                selectedCategory: action.selectedCategory
	            });
	        case _types.ADD_CATEGORY:
	            return Object.assign({}, state, {
	                cats: [].concat(_toConsumableArray(categories), [action])
	            });

	        case _types.REMOVE_CATEGORY:
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HandleHeader = __webpack_require__(196);

	var _HandleHeader2 = _interopRequireDefault(_HandleHeader);
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	    return {
	        addProduct: function addProduct() {
	            dispatch((0, _actions.openProductModal)());
	        },
	        addCategory: function addCategory() {
	            dispatch((0, _actions.openCategoryModal)());
	        }
	    };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.openDeleteCategoryModal = exports.closeCategoryModal = exports.openCategoryModal = exports.selectCategory = exports.fetchCategories = exports.addCategory = exports.removeCategory = exports.closeProductModal = exports.openProductModal = exports.fetchProducts = exports.removeProduct = exports.editProduct = exports.addProduct = exports.openDeleteProductModal = exports.openEditProductModal = exports.closeDeleteModal = undefined;
	...
	//general actions
	var closeDeleteModal = exports.closeDeleteModal = function closeDeleteModal() {
	    return {
	        type: _types.CLOSE_DELETE_MODAL,
	...
	//action for products
	var openEditProductModal = exports.openEditProductModal = function openEditProductModal(id) {
	    return {
	        type: _types.OPEN_EDIT_PRODUCT_MODAL,
	        openEditProductModal: true,
	        productID: id
	    };
	};

	var openDeleteProductModal = exports.openDeleteProductModal = function openDeleteProductModal(id) {
	    return {
	        type: _types.OPEN_DELETE_PRODUCT_MODAL,
	        openDeleteProductModal: true,
	        productID: id
	    };
	};

	var addProduct = exports.addProduct = function addProduct(categoryID, name, purchasePrice, price) {
	    return function (dispatch) {
	        dispatch(closeProductModal());

	        _index2.default.addProduct(categoryID, name, purchasePrice, price, function (response) {
	            dispatch({
	                type: _types.ADD_PRODUCT,
	...
	var editProduct = exports.editProduct = function editProduct(productID, categoryID, name, purchasePrice, price) {
	    return function (dispatch) {
	        dispatch(closeProductModal());
	        dispatch({
	            type: _types.EDIT_PRODUCT,
	            categoryID: categoryID,
	            name: name,
	            purchasePrice: purchasePrice,
	            price: price,
	        ...
	        _index2.default.editProduct(productID, categoryID, name, purchasePrice, price);
	    };
	};

	var removeProduct = exports.removeProduct = function removeProduct(id) {
	    return function (dispatch) {
	        dispatch(closeDeleteModal());
	        dispatch({
	            type: _types.REMOVE_PRODUCT,
	            productID: id
	        });

	        _index2.default.removeProduct(id);
	    };
	};

	var fetchProducts = exports.fetchProducts = function fetchProducts() {
	    return function (dispatch) {
	        _index2.default.fetchProducts(function (response) {
	            dispatch({
	...
	var openProductModal = exports.openProductModal = function openProductModal() {
	    return {
	        type: _types.OPEN_ADD_PRODUCT_MODAL,
	        openAddProductModal: true
	    };
	};

	var closeProductModal = exports.closeProductModal = function closeProductModal() {
	    return {
	        type: _types.CLOSE_PRODUCT_MODAL,
	...
	var removeCategory = exports.removeCategory = function removeCategory(id) {
	    return function (dispatch) {
	        dispatch(closeDeleteModal());
	        _index2.default.removeCategory(id, function (response) {
	            dispatch({
	                type: _types.REMOVE_CATEGORY,
	...
	var addCategory = exports.addCategory = function addCategory(name) {
	    return function (dispatch) {
	        dispatch(closeCategoryModal());

	        _index2.default.addCategory(name, function (response) {
	            dispatch({
	...
	var fetchCategories = exports.fetchCategories = function fetchCategories() {
	    return function (dispatch) {
	        _index2.default.fetchCategories(function (response) {
	            dispatch({
	...
	var selectCategory = exports.selectCategory = function selectCategory(selectedCategory) {
	    return {
	        type: _types.SELECT_CATEGORY,
	        selectedCategory: selectedCategory
	    };
	};

	var openCategoryModal = exports.openCategoryModal = function openCategoryModal() {
	    return {
	        type: _types.OPEN_ADD_CATEGORY_MODAL,
	        openAddCategoryModal: true
	    };
	};

	var closeCategoryModal = exports.closeCategoryModal = function closeCategoryModal() {
	    return {
	        type: _types.CLOSE_CATEGORY_MODAL,
	        openAddCategoryModal: false
	    };
	};

	var openDeleteCategoryModal = exports.openDeleteCategoryModal = function openDeleteCategoryModal(id) {
	    return {
	        type: _types.OPEN_DELETE_CATEGORY_MODAL,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    editProduct: function editProduct(productID, categoryID, name, purchasePrice, price) {
	        _axios2.default.post(ROOT_URL + '/edit_product', { productID: productID, categoryID: categoryID, name: name, purchasePrice: purchasePrice, price: price }).catch(function (err) {
	            console.log('err', err);
	        });
	    },

	    removeProduct: function removeProduct(id) {
	        _axios2.default.post(ROOT_URL + '/remove_product', { id: id }).catch(function (err) {
	            console.log('err', err);
	        });
	    },

	    fetchProducts: function fetchProducts(callback) {
	        _axios2.default.get(ROOT_URL + '/get_products').then(function (response) {
	            callback(response);
	        }).catch(function (err) {
	            console.log('err', err);
	        });
	    ...
	    removeCategory: function removeCategory(id, callback) {
	        _axios2.default.post(ROOT_URL + '/remove_category', { id: id }).then(function (response) {
	            callback(response);
	        }).catch(function (err) {
	            console.log('err', err);
	        });
	    ...
	    addCategory: function addCategory(name, callback) {
	        _axios2.default.post(ROOT_URL + '/add_category', { name: name }).then(function (response) {
	            callback(response);
	        }).catch(function (err) {
	            console.log('err', err);
	        });
	    ...
	    fetchCategories: function fetchCategories(callback) {
	        _axios2.default.get(ROOT_URL + '/get_categories').then(function (response) {
	            callback(response);
	        }).catch(function (err) {
	            console.log('err', err);
	        });
	    ...
	    addProduct: function addProduct(categoryID, name, purchasePrice, price, callback) {
	        _axios2.default.post(ROOT_URL + '/add_product', { categoryID: categoryID, name: name, purchasePrice: purchasePrice, price: price }).then(function (response) {
	            callback(response);
	        }).catch(function (err) {
	            console.log('err', err);
	        });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Header = function Header(_ref) {
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            "button",
	            { type: "button", className: "btn btn-default product-btn", onClick: function onClick() {
	                    addProduct();
	                } },
	            "\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0442\u043E\u0432\u0430\u0440"
	        ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HandleProduct = __webpack_require__(218);

	var _HandleProduct2 = _interopRequireDefault(_HandleProduct);

	var _HandleCategory = __webpack_require__(223);

	var _HandleCategory2 = _interopRequireDefault(_HandleCategory);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ProductList = __webpack_require__(219);
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	    return {
	        edit: function edit(id) {
	            dispatch((0, _actions.openEditProductModal)(id));
	        },
	        remove: function remove(id) {
	            dispatch((0, _actions.openDeleteProductModal)(id));
	        },
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_ProductList2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DeleteModal = __webpack_require__(222);
	        ...
	        value: function renderProducts() {
	            ...
	            for (var j in this.props.products) {
	                if (this.props.products.hasOwnProperty(j)) {
	                    var p = this.props.products[j];
	                    arr.push(_react2.default.createElement(_Product2.default, { id: p.productID, name: p.name, price: p.price,
	...
	var Product = function Product(props) {
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                "button",
	                { className: "btn btn-default product-btn", onClick: function onClick() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProductModal = function (_Component) {
	    ...
	    function ProductModal(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, (ProductModal.__proto__ || Object.getPrototypeOf(ProductModal)).call(this, props));

	        _this.state = { categoryID: 0, name: "", purchasePrice: "", price: "" };

	        _this.cancelClick = _this.cancelClick.bind(_this);
	        _this.handleClickBtn = _this.handleClickBtn.bind(_this);
	        _this.handleChangeCategory = _this.handleChangeCategory.bind(_this);
	        _this.handleChangeName = _this.handleChangeName.bind(_this);
	        _this.handleChangePurchasePrice = _this.handleChangePurchasePrice.bind(_this);
	    ...
	    _createClass(ProductModal, [{
	        ...
	        value: function componentWillReceiveProps(nextProps) {
	            this.setState({
	                categoryID: nextProps.product ? nextProps.product[0].categoryID : nextProps.selectedCategory ? nextProps.selectedCategory : 0,
	            ...
	            for (var j in categories) {
	                if (categories.hasOwnProperty(j)) {
	                    ...
	                    arr.push(_react2.default.createElement(
	                        'option',
	                        { key: 'productModal' + c.categoryID, value: c.categoryID },
	                        c.name
	                    ));
	                }
	            }
	        ...
	        value: function cancelClick() {
	            this.resetState();
	            this.props.dispatch((0, _actions.closeProductModal)());
	        }
	    }, {
	        key: 'handleClickBtn',
	        value: function handleClickBtn() {
	            ...
	            this.props.mode ? this.props.dispatch((0, _actions.addProduct)(this.state.categoryID, this.state.name, this.state.purchasePrice, this.state.price)) : this.props.dispatch((0, _actions.editProduct)(this.props.productID, this.state.categoryID, this.state.name, this.state.purchasePrice, this.state.price));
	            this.resetState();
	        }
	    }, {
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { style: { display: this.props.confirm ? "block" : "none" }, className: 'modal in', role: 'dialog',
	                ...
	                _react2.default.createElement('div', { style: { display: this.props.confirm ? "block" : "none" }, className: 'modal-backdrop in' })
	            );
	        }
	    }]);
	...
	var mapStateToProps = function mapStateToProps(state) {
	    return {
	        ...
	        product: state.product.openEditProductModal ? state.product.prods.filter(function (p) {
	            return p.productID === state.product.productID;
	        }) : null,
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(ProductModal);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DeleteModal = function (_Component) {
	    ...
	    _createClass(DeleteModal, [{
	        key: 'cancelClick',
	        value: function cancelClick() {
	            this.props.dispatch((0, _actions.closeDeleteModal)());
	        }
	    }, {
	        key: 'handleClickBtn',
	        value: function handleClickBtn() {
	            this.props.mode ? this.props.dispatch((0, _actions.removeCategory)(this.props.id)) : this.props.dispatch((0, _actions.removeProduct)(this.props.id));
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                'button',
	                                { type: 'button', onClick: this.cancelClick, className: 'close', 'data-dismiss': 'modal', 'aria-label': 'Close' },
	                                _react2.default.createElement(
	                                    'span',
	                                    { 'aria-hidden': 'true' },
	                                    '\xD7'
	                            ...
	                            _react2.default.createElement(
	                                'h4',
	                                { className: 'modal-title text-holder' },
	                                this.props.mode ? this.props.headerTitle : this.props.headerTitle + ' ID-' + this.props.id + ' ?'
	                            ),
	                            _react2.default.createElement(
	                                'div',
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    'button',
	                                    { type: 'button', className: 'btn btn-primary', onClick: this.handleClickBtn },
	                                    '\u0423\u0434\u0430\u043B\u0438\u0442\u044C'
	                                )
	                            )
	                        )
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(DeleteModal);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CategoriesList = __webpack_require__(224);
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	    return {
	        handleClick: function handleClick(id) {
	            dispatch((0, _actions.openDeleteCategoryModal)(id));
	        },
	        selectCategory: function selectCategory(id) {
	            dispatch((0, _actions.selectCategory)(id));
	        },
	        fetchCategories: function fetchCategories() {
	            dispatch((0, _actions.fetchCategories)());
	        }
	    };
	};

	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_CategoriesList2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CategoryModal = __webpack_require__(225);
	...
	var CategoriesList = function (_Component) {
	    ...
	    function CategoriesList(props) {
	        ...
	        return _possibleConstructorReturn(this, (CategoriesList.__proto__ || Object.getPrototypeOf(CategoriesList)).call(this, props));
	    }
	    ...
	    _createClass(CategoriesList, [{
	        ...
	        value: function renderCategories() {
	            ...
	            var arr = [];
	            for (var i in this.props.categories.cats) {
	                if (this.props.categories.cats.hasOwnProperty(i)) {
	                    (function () {
	                        var obj = _this2.props.categories.cats[i];
	                        arr.push(_react2.default.createElement(
	                            'div',
	                            { key: 'category' + obj.categoryID, className: 'category-item' },
	                            _react2.default.createElement(
	                                'span',
	                                { className: 'btn btn-default', onClick: function onClick(e) {
	                                        return _this2.props.handleClick(obj.categoryID);
	                                    } },
	                                'X'
	                            ),
	                            _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CategoryModal = function (_Component) {
	    _inherits(CategoryModal, _Component);
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                'button',
	                                { type: 'button', onClick: this.cancelClick, className: 'close', 'data-dismiss': 'modal',
	                                    'aria-label': 'Close' },
	                                _react2.default.createElement(
	                                    'span',
	                                    { 'aria-hidden': 'true' },
	                            ...
	                            _react2.default.createElement(
	                                'div',
	                                { className: 'modal-body' },
	                                _react2.default.createElement('input', { type: 'text', name: 'name', value: this.state.name, onChange: this.handleChangeName, className: 'form-control', placeholder: '\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435' })
	                            ),
	                            _react2.default.createElement(
	                                'div',
	                                { className: 'modal-footer' },
	                                _react2.default.createElement(
	                                    'button',
	                                    { type: 'button', className: 'btn btn-primary', autoFocus: this.props.confirm,
	                                        onClick: this.handleClickBtn },
	                                    '\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C'
	                                )
	                            )
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	    return {
	        close: function close() {
	            dispatch((0, _actions.closeCategoryModal)());
	        },
	        handleClick: function handleClick(name) {
	            dispatch((0, _actions.addCategory)(name));
	        }
	    };
	};

	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(CategoryModal);
